...
extern void make_ekran_setpoint_apv_zmn(unsigned int);
extern void make_ekran_timeout_apv_zmn(unsigned int);
extern void make_ekran_control_apv_zmn(void);
...
extern void make_ekran_setpoint_control_U(unsigned int);
extern void make_ekran_timeout_control_U(unsigned int);
extern void make_ekran_control_control_U(void);
...
extern void action_after_changing_phase_line(__SETTINGS *);
...
extern void apv_zmn_handler(unsigned int*, unsigned int);
extern void avr_handler(unsigned int*, unsigned int);
extern void achr_chapv_handler(unsigned int*, unsigned int);
extern void control_U_OL(unsigned int*, unsigned int);
extern void control_U_RL(unsigned int*, unsigned int);
...
extern unsigned int stop_regisrator(unsigned int*, unsigned int*, unsigned int);
...
extern void start_monitoring_min_f1(unsigned int);
extern void continue_monitoring_min_f1(unsigned int);
extern void start_monitoring_min_f2(unsigned int);
extern void continue_monitoring_min_f2(unsigned int);
...
extern void digital_registrator(unsigned int*, unsigned int volatile*, unsigned int);
...
extern void fapch_val_1(unsigned int);
extern void fapch_val_2(unsigned int);
